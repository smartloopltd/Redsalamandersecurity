              ...
              <div className="mx-auto w-full max-w-6xl px-6 py-10 text-white sm:px-8">
                <div className="max-w-3xl">
                  ...
                  <h1 className="mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                    Experienced professionals delivering dependable security and operational support.
                  </h1>
                  <p className="mt-4 max-w-2xl text-base leading-7 text-slate-100 sm:text-lg">
                    Red Salamander Operations, Nigeria Ltd brings together skilled experts who provide reliable security, logistics, and operational continuity.
                  </p>
                </div>
              </div>
            </div>

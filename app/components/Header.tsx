...
export default function Header() {
  ...
  return (
    <header ref={headerRef} className="sticky top-0 w-full z-[70] bg-red-600 text-white shadow-lg shadow-red-600/20">
      ...
      <div
        className={`fixed right-0 left-0 z-[50] flex flex-col bg-red-700 text-white overflow-hidden w-full transform-gpu will-change-transform p-6 pb-10 transition-transform transition-opacity duration-400 ease-in-out shadow-2xl shadow-black/25 ${
